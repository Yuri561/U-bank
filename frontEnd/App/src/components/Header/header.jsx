...
const Header = () => {
  ...
  return (
    <header className='shadow-md font-[sans-serif] tracking-wide relative z-50 fixed w-full'>
    <section
      className=' text-white md:flex lg:items-center relative py-3 lg:px-10 px-4 border-gray-200 bg-yellow-500 border-b bg-gray-800 text-white lg:min-h-[80px] max-lg:min-h-[60px]'>
      <a href="javascript:void(0)" className="max-sm:w-full max-sm:mb-3 shrink-0"><img
          src={Logo} alt="logo" className='w-[30px], h-[30px]' />
      </a>
  
      <div className='flex flex-wrap w-full items-center text-[#333]' style={{color: 'whitesmoke'}}>
        ...
        <div className="ml-auto max-lg:mt-4">
          ...
          <ul className='flex items-center text-white'>
            ...
            <li className='flex text-[15px] text-[#333] max-lg:py-2 px-3 hover:text-[#ffff] hover:fill-[#ffff]'>
              <button
                className='px-4 py-2 text-sm rounded font-semibold text-[#333] border-2 border-[#333] bg-transparent'>Sign
                In</button>
            </li>
    ...
    <div id="collapseMenu"
      ...
      <ul
        ...
        <li className='max-lg:border-b max-lg:py-3 px-3'><Link to='cards'
            className='hover:text-yellow-300 text-white text-[15px] font-medium block'>Cards</Link></li>
        <li className='max-lg:border-b max-lg:py-3 px-3'><Link to='homeowners'
            className='hover:text-yellow-300 text-white text-[15px] font-medium block'>Homeowner</Link></li>
        <li className='max-lg:border-b max-lg:py-3 px-3'><Link to='auto'
            className='hover:text-yellow-300 text-white text-[15px] font-medium block'>Auto</Link></li>
        <li className='max-lg:border-b max-lg:py-3 px-3'><Link to='insurances-benefits'
            className='hover:text-yellow-300 text-white text-[15px] font-medium block'>Insurances & Benefits</Link></li>
        <li className='max-lg:border-b max-lg:py-3 px-3'><Link to='cashbacks'
            className='hover:text-yellow-300 text-white text-[15px] font-medium block'>Cashbacks</Link></li>
        <li className='max-lg:border-b max-lg:py-3 px-3'><Link to='blog'
            className='hover:text-yellow-300 text-white text-[15px] font-medium block'>Blog</Link></li>
        <li className='max-lg:border-b max-lg:py-3 px-3'><Link to='about-us'
            className='hover:text-yellow-300 text-white text-[15px] font-medium block'>About</Link></li>
        <li className='max-lg:border-b max-lg:py-3 px-3'><Link to='contact-us'
            className='hover:text-yellow-300 text-white text-[15px] font-medium block'>Contact Us</Link></li>
      </ul>
    </div>
  </header>
