...
const Auto = () => {
  return (
    <div className='py-12'>
      <div className="min-h-[400px] bg-gradient-to-b from-blue-900 via-blue-800 to-blue-500 px-6 sm:py-20 mb-12 py-10 font-[sans-serif]">
      <div className="max-w-screen-xl mx-auto text-center text-white">
        <h1 className="text-5xl max-sm:text-3xl font-extrabold leading-tight mb-6">Auto Financing made Easy</h1>
        <p className="text-lg mb-12">Experience financing like never before with our exclusive rates and deals.</p>
        <button type="button" className="bg-blue-600 text-white text-lg tracking-wide px-8 py-2.5 rounded-full transition duration-300 ease-in-out shadow-lg hover:shadow-xl">Get Qualified</button>
      </div>
    </div>
      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-6 px-4 my-12">
        <div className="bg-gray-100 p-6 rounded-md shadow-lg transition-transform transform hover:scale-105">
          ...
          <p className="text-sm text-gray-600">Choose your payment regardless of credit</p>
          <a href="javascript:void(0);" className="text-blue-600 font-bold inline-block text-sm mt-4 hover:underline">
            Learn more
          </a>
        </div>
        <div className="bg-gray-100 p-6 rounded-md shadow-lg transition-transform transform hover:scale-105">
        ...
        <div className="bg-gray-100 p-6 rounded-md shadow-lg transition-transform transform hover:scale-105">
          ...
          <h3 className="text-lg font-bold mb-2 text-gray-800">Zero Credit Check</h3>
          <p className="text-sm text-gray-600">With U-bank we help build your credit by not touching your credit</p>
          <a href="javascript:void(0);" className="text-blue-600 font-bold inline-block text-sm mt-4 hover:underline">
            Learn more
          </a>
        </div>
