...
const Auto = () => {
  return (
		<div className='py-12'>
			<div className='min-h-[400px] bg-gradient-to-b from-blue-900 via-blue-800 to-blue-500 px-6 py-10 sm:py-20 mb-12 font-[sans-serif] text-white'>
				<div className='max-w-screen-xl mx-auto text-center text-white sm-mt-7-important'>
					...
					<p className='text-lg mb-12'>
						Experience financing like never before with U-bank exclusive rates
						and deals.
					</p>
					<button
						type='button'
			...
			<div className='max-w-screen-xl mx-auto text-center rounded-lg bg-white text-black shadow-lg'>
				<div className='grid lg:grid-cols-2 gap-6'>
					<div className='p-6 bg-blue-50 rounded-lg shadow-md'>
						...
						<p className='mb-4'>
							Get the best rates and terms for your new or used car.
						</p>
					...
					<div className='p-6 bg-blue-50 rounded-lg shadow-md'>
						<h2 className='text-2xl font-bold mb-4'>Calculate Your Payment</h2>
						<p className='mb-4'>
			...
			<div className='grid lg:grid-cols-4 md:grid-cols-2 gap-6 px-4 my-12'>
				<div className='bg-gray-100 p-6 rounded-md shadow-lg transition-transform transform hover:scale-105'>
					...
					<p className='text-sm text-gray-600'>
						Choose your payment regardless of credit
					</p>
					<a
